...
for(Category category: Category.values())
{
	...
	<%--  <form class="form-horizontal" name="product" action="saveProduct" method="post" >  --%>
  ...
  <input id="product_id" name="product_id" placeholder="PRODUCT ID" class="form-control input-md" required="" type="text">
			...
			<%-- <form:input type="hidden" path="id" id="${product.getProduct_id() }"/> --%>
			<!-- Text input-->
			<div class="form-group">
 ...
 -->
        ...
        <form:options items="${category}" itemLabel="category"  />
</form:select>
  --%>
				</div>
			</div>
			...
			<!-- Text input-->
			<div class="form-group">
				<label class="col-md-4 control-label" for="available_quantity">PRODUCT
					QUANTITY</label>
				<div class="col-md-4">
					<input id="available_quantity" name="product_qty"
  ...
  <input id="product_weight" name="product_weight" placeholder="PRODUCT WEIGHT" class="form-control input-md" required="" type="text">
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="product_description">PRODUCT
					DESCRIPTION</label>
				<div class="col-md-4">
					<textarea class="form-control" id="product_desc"
  ...
  <div class="col-md-4">                     
    <textarea class="form-control" id="product_name_fr" name="product_name_fr"></textarea>
			...
			<!-- Text input-->
			<div class="form-group">
				<label class="col-md-4 control-label" for="stock_alert">STOCK
					ALERT</label>
				<div class="col-md-4">
					<input id="stock_alert" name="stock_alert"
						placeholder="STOCK ALERT" class="form-control input-md"
						required="" type="text">
			...
			<!-- Search input-->
			<div class="form-group">
				<label class="col-md-4 control-label" for="stock_critical">STOCK
					CRITICAL</label>
				<div class="col-md-4">
					<input id="stock_critical" name="stock_critical"
						placeholder="STOCK CRITICAL" class="form-control input-md"
						required="" type="text">
 ...
 -->
  ...
  <div class="col-md-4">
    <input id="tutorial_fr" name="tutorial_fr" placeholder="TUTORIAL FR" class="form-control input-md" required="" type="search">
			...
			<!-- Text input-->
			<!-- <div class="form-group">
  <label class="col-md-4 control-label" for="online_date">EXPIRY DATE</label>  
  <div class="col-md-4">
  <input id="online_date" name=" product_exp_date" placeholder="ONLINE DATE" class="form-control input-md" required="" type="text">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="product_price" name="product_price"
						placeholder="product_price" class="form-control input-md"
						required="" type="text">
    ...
    <input id="filebutton" name="filebutton" class="input-file" type="file">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					...
					<input type="submit" name="singlebutton" value="ADD"
